...
class ClassMethodTest extends TestCase
{
    ...
    public function testGetDeclaration(array $args, ?string $returnType, bool $isStatic, string $expectedDeclaration)
    {
    ...
    public function declarationsProvider(): \Generator
    {
        ...
        yield [
            [
                new MethodArgument('toto', 'array'),
                new MethodArgument('args', 'string', isVariadic: true),
            ],
            null,
            false,
            'public function foobar(array $toto, string ...$args)',
        ];
    }

    /** @dataProvider argumentsUsesProvider */
    public function testGetArgumentsUse(array $args, string $expectedDeclaration)
    {
