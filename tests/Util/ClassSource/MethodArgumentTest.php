...
class MethodArgumentTest extends TestCase
{
    ...
    public function testGetDeclaration(?string $type, ?string $default, bool $isVariadic, string $expected)
    {
        $methodArgument = new MethodArgument('foo', $type, $default, $isVariadic);
    ...
    {
        $this->assertFalse((new MethodArgument('foo'))->isVariadic());
        $this->assertTrue((new MethodArgument('foo', isVariadic: true))->isVariadic());
    }
