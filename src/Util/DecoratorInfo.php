...
final class DecoratorInfo
{
    ...
    public function __construct(
        ...
        if (null === $onInvalid) {
            ...
            $onInvalidConstants = [
                'EXCEPTION_ON_INVALID_REFERENCE' => ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE,
                'NULL_ON_INVALID_REFERENCE' => ContainerInterface::NULL_ON_INVALID_REFERENCE,
                'IGNORE_ON_INVALID_REFERENCE' => ContainerInterface::IGNORE_ON_INVALID_REFERENCE,
                'RUNTIME_EXCEPTION_ON_INVALID_REFERENCE' => ContainerInterface::RUNTIME_EXCEPTION_ON_INVALID_REFERENCE,
            ];

            if (false === $name = array_search($onInvalid, $onInvalidConstants, true)) {
                throw new RuntimeCommandException(\sprintf('Invalid "onInvalid" value "%d", it must be one of "%s".', $onInvalid, implode(', ', $onInvalidConstants)));
            }
